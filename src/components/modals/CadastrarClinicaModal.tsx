...
interface CadastrarClinicaModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (clinicData: any) => void;
}

const CadastrarClinicaModal: React.FC<CadastrarClinicaModalProps> = ({ isOpen, onClose, onSave }) => {
      ...
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="bg-gray-50 p-4 border-t flex justify-end items-center gap-4">
            ...
            <button type="submit" className="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700">Cadastrar</button>
          </div>
        </form>
      </div>
    </div>
...
export default CadastrarClinicaModal;
